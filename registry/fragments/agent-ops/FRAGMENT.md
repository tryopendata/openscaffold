...
This stack's own `.claude/settings.json` merges in allow rules for its `bun run` scripts, so they're already approved; add rules only for commands you create beyond those.
<!-- openscaffold:end -->
